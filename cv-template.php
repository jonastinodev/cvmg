<?php
// cv-template.php — Construit le HTML du CV à partir d'un tableau de données.
// Utilisé à la fois pour l'aperçu dans le navigateur et pour la génération PDF
// (même gabarit, même rendu garanti).
//
// Structure attendue de $cv :
// [
//   'personnel' => ['nom', 'prenom', 'titre_professionnel', 'profil_court',
//                    'telephone', 'email', 'ville', 'permis_conduire', 'photo_url'],
